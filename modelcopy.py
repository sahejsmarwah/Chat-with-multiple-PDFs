    ...
    for file in files:
        ...
        try:
            if loader_type == "PDF":
                ...
                print("Wrong File Type, I can work only on pdf files")
        finally:
...
def main():
    ...
    vector_store_path = "../data/vectorstore/my_store"
    ...
    with st.sidebar:
        st.title("Documents:")
        data_files = st.file_uploader("Upload your Files Here and Click on 'Submit'", accept_multiple_files=True)
        if st.button("Submit"):
